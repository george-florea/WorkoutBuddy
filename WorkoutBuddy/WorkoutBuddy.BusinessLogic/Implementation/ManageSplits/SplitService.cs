...
using WorkoutBuddy.BusinessLogic.Implementation.ManageSplits;
...
namespace WorkoutBuddy.BusinessLogic.Implementation
{
    public class SplitService : BaseService
    {
        ...
        public List<SplitListItem> GetSplits()
        {
            var splits = UnitOfWork.Splits.Get()
