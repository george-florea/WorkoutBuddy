...
{
    public partial class ProiectAcademieContext : DbContext
    {
        public ProiectAcademieContext()
        {
        }

        public ProiectAcademieContext(DbContextOptions<ProiectAcademieContext> options)
            : base(options)
        {
        }
