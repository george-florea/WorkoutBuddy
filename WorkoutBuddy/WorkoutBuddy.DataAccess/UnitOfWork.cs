...
namespace WorkoutBuddy.DataAccess
{
    ...
    {
        private readonly WorkoutBuddyContext Context;

        public UnitOfWork(WorkoutBuddyContext context)
        {
            Context = context;
        }
        ...
        private IRepository<Split> split;
        public IRepository<Split> Splits => split ?? (split = new BaseRepository<Split>(Context));
